...
$(function () {
    $(".alineacion-derecha").dblclick(function (e) {
        e.stopPropagation();
        var currentEle = $(this);
        var value = $(this).html();
...
function formatear(value){
	...
	racional = number.split(",");
	number = replaceAll (racional[0],'.','');
	
	 if (racional.length == 1)
	  decimales = '00';
	 else
 	  decimales = racional[1];
...
<body>
	<div class="container">
      ...
      <li class="active" onclick="javascript:redireccionar('modificar-presupuesto-form');">
       <a>
...
<div class="centro">
<form id="realizar-busqueda-form" action ="http://localhost:8080/modificarpresupuesto.html" method="post" onsubmit="return validateSolicitude(this);">
  ...
  <!-- tabla que muestra el presupuesto comercial si marcaron la opcion "bolivares" o "piezas" en tipo registro -->	
	...
	<TABLE width="20%">
	<TD> <input class="btn btn-default" name="descartar" id="descartar" value="Descartar Cambios" type="submit" onclick="javascript:cambiar_texto('descartar','Descartando...')">
	  <TD><input class="btn btn-default" id="guardar" value="Guardar Cambios" onclick="javascript:guardarCambios(this)"></TD>
	  <TD><input class="btn btn-default" id="exportar" name="exportar" value="Exportar" type="submit"></TD>
	  <TD><input style="margin-left:15%" type="file" id="csvFileInput" name="fileModificar"></TD>
      <TD><input style="margin-left:70%" type="button" id="btn-export" class="btn btn-default" value="Importar" 
