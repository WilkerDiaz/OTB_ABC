...
<form id="realizar-busqueda-form" action ="http://localhost:8080/ordendecompra.html" method="post" onsubmit="return validateSolicitude(this);">
  ...
  <TABLE cellpadding="1" width="95%">
   ...
   <!-- Primera Fila: Concepto y cantidad-->
   <TR >
      <TD>
      ...
      <TD colspan="6">
         <c:forEach items="${productos}" var="producto">
             <input style="width: 560px" type="text" value="${producto.concepto}">  
        </c:forEach>
      </TD>  
    </TR>
    
      <!-- Segunda Fila: Precio e impuesto -->
    <TR>
      <TD >
      ...
      <TD>
        <c:forEach items="${productos}" var="producto">
             <input class = "span3" type="text" value="${producto.departamento}">  
        </c:forEach>
      </TD>
   ...
   <TR >
      ...
      <TD>
         <c:forEach items="${productos}" var="producto">
             <input class="span3" type="text" value="${producto.tipo}">  
        </c:forEach>
      </TD>  
    </TR>
    ...
    <TR>
      ...
      <TD>
		<p style="padding-left:20px" align="left">Precio </p>
	  </TD>
